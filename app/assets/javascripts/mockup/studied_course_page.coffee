@StudiedCoursesPage = React.createClass
  getInitialState: ->
    courses: @props.data
    
  render: ->
    console.log @props.data
    <div className='studied-courses-page'>
      <CoursesPage.TopCover />
      <div className='ui container'>
        <div className='cards-bg ui segment basic'>
        <StudiedCoursesPage.Subjects data={@props.data.studing_and_studied} />
        <StudiedCoursesPage.Cards data={@props.data.courses} />
        <StudiedCoursesPage.Pagination data={@props.data.paginate} />
        </div>
      </div>
    </div>
